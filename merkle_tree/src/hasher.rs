...
//!
//! ```
//! # use jf_merkle_tree_compat::errors::MerkleTreeError;
//! use jf_merkle_tree_compat::{hasher::HasherMerkleTree, AppendableMerkleTreeScheme, MerkleCommitment, MerkleTreeScheme};
//! use sha2::Sha256;
//!
...
/// Do this:
/// ```
/// # use jf_merkle_tree_compat::{hasher::HasherMerkleTree, AppendableMerkleTreeScheme};
/// # use jf_merkle_tree_compat::hasher::HasherDigest;
